...
programs["0ca9ddb6"] = [
    ...
    "    ,",
    "       comparison(",
    "       equalR(testing_output_read(), get1())",
    "       ,",
    "       testing_set_output_value(get_testing_output_position_x(), sub(get_testing_output_position_y(), get1()), get7())",
    "       testing_set_output_value(get_testing_output_position_x(), add(get_testing_output_position_y(), get1()), get7())",
    "       testing_set_output_value(sub(get_testing_output_position_x(), get1()), get_testing_output_position_y(), get7())",
    "       testing_set_output_value(add(get_testing_output_position_x(), get1()), get_testing_output_position_y(), get7())",
    "       ,",
    "           comparison(",
    "           equalR(testing_output_read(), get2())",
    "           ,",
    "           testing_set_output_value(sub(get_testing_output_position_x(), get1()), sub(get_testing_output_position_y(), get1()), get4())",
    "           testing_set_output_value(add(get_testing_output_position_x(), get1()), add(get_testing_output_position_y(), get1()), get4())",
    "           testing_set_output_value(sub(get_testing_output_position_x(), get1()), add(get_testing_output_position_y(), get1()), get4())",
    "           testing_set_output_value(add(get_testing_output_position_x(), get1()), sub(get_testing_output_position_y(), get1()), get4())",
    "           ,",
...
programs["2281f1f4"] = [
    "write_memory(get0(), sub(get_testing_length_output_x(),get1()))",
    "write_memory(get1(), add(get9(), get1()))",
    "loop(",
    "get_testing_length_output_x()",
    ",",
    "    loop(",
    "    get_testing_length_output_y()",
    "    ,",
    "        write_memory(get2(), add(testing_get_output_value(read_memory(get0()), get_testing_output_position_y()),testing_get_output_value(get_testing_output_position_x(), get0())))",
    "        comparison(",
    "        equalR(read_memory(get2()), read_memory(get1()))",
    "        ,",
    "        testing_output_write(get2())",
    "        ,",
    "        write_memory(get3(), read_memory(get3()))",
    "        )",
    "    testing_output_move_down()",
    "    )",
    "testing_output_move_right()",
    "testing_reset_output_down_position()",
    ")",
    "status_end()"
]
...
programs["253bf280"]=[
    ...
    "    ,",
    "        comparison(",
    "        equalR(testing_output_read(), get8())",
    "        ,",
    "        write_memory(get0(), add(read_memory(get0()), get1()))",
    "        ,",
    "        write_memory(get0(), read_memory(get0()))",
    "        )",
    "    testing_output_move_right()",
    ...
    "   equalR(read_memory(get0()), get2())",
    "   ,",
    "   testing_set_output_position(get_testing_output_position_x(), get0())",
    "   write_memory(get0(), get0())",
    "       loop(",
    "       get_testing_length_output_y()",
    "       ,",
...
programs["a5f85a15"] = [
    "write_memory(get0(), get0())",
    "write_memory(get2(), get0())",
    "loop(",
    "get_testing_length_output_y()",
    ",",
    "   comparison(",
    "   equalR(testing_output_read(), get0())",
    "   ,",
    "   write_memory(get3(), read_memory(get3()))",
    "   ,",
    ...
    "   ,",
    "   write_memory(get1(), get1())",
    "   ,",
    "       comparison(",
    "       equalR(read_memory(get2()), get0())",
    "       ,",
    "       write_memory(get2(), get1())",
    "       ,",
    "       testing_output_write(get4())",
    "       write_memory(get2(), get0())",
    "       )",
    "   testing_output_move_right()",
    "   )",
